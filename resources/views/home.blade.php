...
{{-- @section('titulo, 'Home - Seu portal de noticia') --}}
...
@section('conteudo')
        ...
        <div class="grid grid-1 lg:grid-cols-3 gap-6 my-10">
            ...
            <article class="bg-white shadow-sm hover:shadow-md rounded-xl border border-slate-200 overflow-hidden group">
                ...
                <div class="p-5">
                    ...
                    <h3 class="font-bold text-slate-800 mb-2 group-hover:text-blue-600">PHP Continua Dominando o Desenvolvimento
                        Web</h3>
                    <p class="text-sm text-slate-500 mb-4">Descubra por que PHP segue sendo a linguagem mais utilizada para o
                        desenvolvimento de
                        aplicações Web</p>
        ...
        <div class="flex justify-center items-center gap-1.5">
            <a href="#" class="bg-slate-100 text-sm font-semibold rounded-lg px-3 py-1.5 border border-slate-200">Anterior</a>
            ...
            <a href="#" class="bg-slate-100 text-sm  font-semibold rounded-lg px-3 py-1.5 border border-slate-200">Próximo</a>
        </div>
